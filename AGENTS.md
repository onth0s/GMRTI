...
- **PEBBLE.md is a Compiled Artifact**: `PEBBLE.md` is generated by `pebble.py`
  from `[PLAIN]` blocks in the `src/` source files. Never edit `PEBBLE.md`
  directly. All authoring happens in the `src/` files. `PEBBLE.md` must be
  understandable by a high-schooler; the full GMRTI treatise may require a
  graduate student.
